...
const PRODUCTS = [
  ...
  { key: "lem", domain: "https://lem.in.ua", tag: "Group Monitoring AI" },
];
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {PRODUCTS.map((product, i) => {
            const cardInner = (
              <div className="p-8">
                <div className="flex items-start justify-between mb-6">
                  ...
                  {product.domain && (
                    <span className="text-gray-300 group-hover:text-blue-500 transition-colors duration-200">
                ...
                {product.domain && (
                  <span className="mt-6 inline-flex items-center gap-2 text-sm font-medium text-blue-600 group-hover:text-blue-800 transition-colors">
                    {t("visit")}
            ...
            const cardClass =
              "group rounded-2xl border border-gray-100 hover:border-blue-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 overflow-hidden h-full block";
